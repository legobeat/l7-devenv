...
function _G.enable_lsp_keybindings()
  ...
  vim.keymap.set('n', '"', function() vim.lsp.buf.hover() end, {desc = 'Show hover', silent = true })
  vim.keymap.set('n', 'gi', function() vim.lsp.buf.implementation() end, {desc = 'Go to implementation', silent = true })
  vim.keymap.set('n', '<C-k>', function() vim.lsp.buf.signature_help() end, {desc = 'Show signature help', silent = true })
  vim.keymap.set('n', '<space>wa', function() vim.lsp.buf.add_workspace_folder() end, {desc = 'Add workspace folder', silent = true })
  vim.keymap.set('n', '<space>wr', function() vim.lsp.buf.remove_workspace_folder() end, {desc = 'Remove workspace folder', silent = true })
  vim.keymap.set('n', '<space>wl', function()
    print(vim.inspect(vim.lsp.buf.list_workspace_folders()))
  end, {desc = 'List workspace folders', silent = true })
  vim.keymap.set('n', '<space>D', function() vim.lsp.buf.type_definition() end, {desc = 'Go to type definition', silent = true })
  vim.keymap.set('n', '<space>rn', function() vim.lsp.buf.rename() end, {desc = 'Rename', silent = true })
  vim.keymap.set('n', '<space>ca', function() vim.lsp.buf.code_action() end, {desc = 'Select code action', silent = true })
  vim.keymap.set('n', 'gr', function() vim.lsp.buf.references() end, {desc = 'Show references', silent = true })
  vim.keymap.set('n', '<space>f', function() vim.lsp.buf.format() end, {desc = 'Format buffer', silent = true })
end
